...
const AboutPlatform: React.FC = () => {
    ...
    const features = [
        {
            ...
            description: "Contribute to global sustainability efforts by participating in eco-friendly projects that drive real environmental change.",
            image: "https://public.readdy.ai/ai/img_res/7c54135574d5d414b389d93c1a7b7890.jpg",
            icon: "fa-leaf",
        },
        {
            title: "Join Sustainability Programs",
            description: "Explore and enroll in impactful eco-projects, from tree planting to renewable energy initiatives, tailored to your interests.",
            image: "https://public.readdy.ai/ai/img_res/e4e3dce6013e68f999ad1b10d2bbb542.jpg",
            icon: "fa-hand-holding-seedling",
        },
        {
            title: "See Your Positive Impact",
            description: "Track your progress with live updates, view carbon credits earned, and celebrate milestones in your sustainability journey.",
            image: "https://public.readdy.ai/ai/img_res/4fecc3a1bae14359b3058538f439cc6a.jpg",
            icon: "fa-globe",
        },
    ];
    ...
    return (
        <div className="container mx-auto px-4 sm:px-6 md:px-8 py-16 sm:py-20 md:py-24 bg-gradient-to-b from-white to-green-50">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-800 mb-12 sm:mb-16 text-center">How Our Platform Works</h2>

            {/* Features Section */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-12">
                {features.map((item, index) => (
                    <FeatureCard key={index} item={item} index={index} scrollY={scrollY} />
                ))}
            </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
                    <div className="relative">
                        ...
                        <div className="absolute -bottom-4 sm:-bottom-6 -right-4 sm:-right-6 bg-green-500 text-white p-4 sm:p-6 rounded-xl shadow-lg">
                            ...
                            <div className="text-xs sm:text-sm opacity-90">Verified Projects</div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <button className="mt-6 sm:mt-8 bg-green-500 hover:bg-green-600 text-white px-6 sm:px-8 py-2 sm:py-3 text-sm sm:text-lg font-semibold transition-all duration-300 transform hover:scale-105 hover:shadow-lg flex items-center group">
                            <Link to='/program'>Start Compensating</Link>
...
const FeatureCard: React.FC<{ item: any; index: number; scrollY: number; }> = ({ item, index, scrollY }) => (
    <div
    ...
    >
        ...
        <div className="flex items-center mb-3 sm:mb-4">
            ...
            <h3 className="text-lg sm:text-xl font-bold text-gray-800 ml-3 sm:ml-4">{item.title}</h3>
        </div>
