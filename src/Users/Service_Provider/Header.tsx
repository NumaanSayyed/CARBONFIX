...
//           unique_participant : carbonResponse.data.unique_participants_enrolled
//         });

//         // console.log("Hummi getting enrool part",carbonCredits.generated);
//       } catch (error) {
...
//               { value: carbonCredits.unique_participant, name: "Enrolled Participants" },
//             ],
//             label: {
//               show: false,
//             },
...
//               value={carbonCredits.unique_participant.toString()}
//               bgColor="purple"
//               iconClass="fa-users"
//               progressWidth="w-1/2"
//             />
...
const Header: React.FC = () => {
  ...
  useEffect(() => {
    if (chartRef.current) {
      ...
      // Ensure chart still shows something even if all values are zero
