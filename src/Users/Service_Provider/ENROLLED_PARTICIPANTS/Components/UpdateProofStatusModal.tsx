...
const UpdateProofStatusModal: React.FC<UpdateProofStatusModalProps> = ({
    ...
    const handleUpdate = () => {
        if ((!imageFile && !imageURL) || (!videoFile && !videoURL)) {
            alert("Please provide either a file or a URL for both image and video proofs.");
            return;
        }
                    ...
                    <div>
                        ...
                        <div className="relative mt-2">
                            <input
                                ...
                                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none"
                            />
                            {imageURL && <p className="text-sm text-green-600 mt-2">✅ URL Provided</p>}
                    ...
                    <div>
                        ...
                        <div className="relative mt-2">
                            <input
                                ...
                                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none"
                            />
                            {videoURL && <p className="text-sm text-green-600 mt-2">✅ URL Provided</p>}
