            ...
            {programs.map((program) => (
                ...
                >
                    ...
                    <div className="flex items-center justify-between mb-6 relative">
                        ...
                        <span
                            className={`px-4 py-1.5 rounded-full text-sm font-medium transition-all duration-300 ${program.status === "Active"
                        ...
                        >
                            <i
                                className={`fas fa-circle text-xs mr-2 ${program.status === "Active"
                                        ? "text-green-500"
                                        : program.status === "Pending"
                                            ? "text-yellow-500"
                                            : "text-blue-500"
