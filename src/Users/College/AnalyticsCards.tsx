      ...
      {[
        {
          ...
          onClick: () => navigate("/college/students"), // Navigate to student list
        },
        {
          key: "carbonCredits",
        ...
        <div
          key={card.key}
          onClick={card.onClick} // Click event for "Total Students"
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <div className={`w-12 h-12 ${card.bgColor} rounded-full flex items-center justify-center shadow-md`}>
          ...
          {card.progressBar && (
            <div className="mt-4">
              <div className="w-full bg-gray-200 rounded-full h-2">
                <div className={`${card.progressBar.color} h-2 rounded-full`} style={{ width: card.progressBar.percentage }}></div>
              </div>
            </div>
          )}
        </div>
