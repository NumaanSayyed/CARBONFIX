...
const Header: React.FC<HeaderProps> = ({ collegeName }) => {
  return (
    <header className="py-8">
      <div className="flex justify-between items-center">
        <div className="animate-fadeIn">
          {/* Display the dynamic college name */}
          <h1 className="text-4xl font-bold text-gray-900 tracking-tight">
            {collegeName || "Loading..."} {/* Display college name or "Loading..." */}
          </h1>
          <p className="text-gray-600 mt-2 text-lg tracking-wide">
            sustainability@{collegeName.toLowerCase().replace(/ /g, "")}.edu
          </p>
        </div>
