    ...
    const roles = [
        {
            ...
            bgImage: 'https://public.readdy.ai/ai/img_res/3107fc536b948261e7b284a139f19fe7.jpg'
        },
        {
            id: 'college',
            title: 'College',
            ...
            bgImage: 'https://public.readdy.ai/ai/img_res/73797788cf92429214913353b38b2dc8.jpg'
        },
        {
            id: 'provider',
            ...
            bgImage: 'https://public.readdy.ai/ai/img_res/ef2d258638c75e806ecee1043adf2c5b.jpg'
        }
    ];
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-12">
                    {roles.map(role => (
                        <div
                            ...
                            className={`relative cursor-pointer transform transition-all duration-300 hover:scale-105 ${selectedRole === role.id
                        ...
                        {selectedRole === 'college' && (
                            <>
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-1">Deputy Name</label>
                                        <input
                                            type="text"
                                            name="deputyName"
                                            className="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
